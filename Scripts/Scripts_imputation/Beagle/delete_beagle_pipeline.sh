...
ref_snps_gt="REF.chr20.snps.gt.vcf.gz" #REF.chr20.snps.gt.vcf.gz

chrom=$( bcftools query -f '%CHROM\n' "$splitting_path$ref_snps_gt" | head -1 )
startpos=$( bcftools query -f '%POS\n' "$splitting_path$ref_snps_gt" | head -1 )
endpos=$( bcftools query -f '%POS\n' "$splitting_path$ref_snps_gt" | tail -1 )
...
echo '.................................................................................'
reftruefmt=$( bcftools query -f '%LINE\n' "$splitting_path$ref_snps_gt" | head -1 | cut -f9 )
